...
:page-background-image: image::images/draft_watermark.png[opacity=50%]

:title: July 2021 OGC API Code Sprint Summary Engineering Report

:initiative_short_name: 202107APISprintER-ID
...
:workingGroup: SWG/DWG for Review: Architecture DWG
...
include::5-architecture.adoc[]

include::6-results.adoc[]

include::7-discussion.adoc[]

include::8-conclusions.adoc[]
